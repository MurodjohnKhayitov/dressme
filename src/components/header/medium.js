  ...
  return (
    <div className={`flex flex-col`}>
        <div className="w-full max-w-[1440px] ss:px-4 md:px-[130px] mx-auto">
            ...
            <div className="ss:w-full md:w-fit flex items-center ss:justify-between md:justify-start relative">
                {/* Menu section */}
                <div onClick={toggleHamburger} className={`flex items-center justify-center ss:w-fit bg-bgColor border border-searchBgColor px-4 h-12 rounded cursor-pointer md:hidden`}>
            ...
            <Link
                to="#"
                className="flex items-center justify-center bg-bgColor border border-searchBgColor rounded px-4 h-10 mt-3 md:h-12 ss:text-sm md:w-[98px] md:mt-0 ss:hidden md:flex"
            >
            ...
            <div className="flex flex-wrap items-center justify-between mt-6 rounded  mb-4 ss:w-full">
                ...
                <button onClick={() => { setToggle(!toggle);}}
                    className="flex items-center bg-btnBgColor font-medium  ss:w-full  sm:w-[30%] ss:mt-4 sm:m-0  h-10 rounded border border-gray-200 px-5">
